...
# the ./docs dir is published as https://udhos.github.io/eks-auto-pod-id-assoc/

chart_dir=charts/eks-auto-pod-id-assoc
chart_url=https://udhos.github.io/eks-auto-pod-id-assoc/
